...
import com.cheng.weixin.user.GetUserInfo;
import com.cheng.weixin.user.UserConfig;
import com.cheng.weixin.user.UserController;
import com.cheng.weixin.user.UserInfo;
import com.cheng.weixin.user.UserConfig.LangType;
...
public final class WeiXinUserUtils {
...
//				ApiResult batchGetUserInfo = UserApi.batchGetUserInfo(jsonGetUserInfo);
	...
	public List<UserInfo> saveUserInfo(){
		List<UserInfo> userInfos=new ArrayList<UserInfo>();
		for (int i = 0; i < 10; i++) {
	...
	public List<UserInfo> parseJsonToUserInfo(String jsonResult){
